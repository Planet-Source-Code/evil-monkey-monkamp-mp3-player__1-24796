...
Option Explicit
' $Author: Joe.williams $
' $Date: 11/17/99 10:39a $
' $Modtime: 6/14/99 10:55a $
' $Revision: 1 $
' $Logfile: /R&R Integration/NY/Imports/Registry.bas $
' $History: Registry.bas $
''
'*****************  Version 1  *****************'
'User: Joe.williams Date: 11/17/99   Time: 10:39a'
'Created in $/R&R Integration/NY/Imports'
''
'*****************  Version 9  *****************'
'User: John.lambert Date: 6/11/99    Time: 2:46p'
'Updated in $/emailImporter'
Public Enum RegType
    REG_SZ = 1
    REG_DWORD = 4
End Enum
